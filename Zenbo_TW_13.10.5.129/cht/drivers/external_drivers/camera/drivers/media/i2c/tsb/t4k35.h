...
/************************** settings for tsb *************************/
static struct tsb_reg const t4k35_Full_3280x2464_25fps[] = {
	...
	{TSB_8BIT, 0x0341, 0xE4},    /* FR_LENGTH_LINES[7:0] */
	...
	{TSB_8BIT, 0x0821, 0x66},    /* MSB_LBRATE[23:16] */
...
static struct tsb_reg const t4k35_Full_3280x2464_15fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{TSB_8BIT, 0x0301, 0x01},    /* -/-/-/-/VT_PIX_CLK_DIV[3:0] */
	...
	{TSB_8BIT, 0x0343, 0x32},    /* LINE_LENGTH_PCK[7:0] */
	{TSB_8BIT, 0x0346, 0x00},    /* Y_ADDR_START[15:8] */
	{TSB_8BIT, 0x0347, 0x00},    /* Y_ADDR_START[7:0] */
	{TSB_8BIT, 0x034A, 0x09},    /* Y_ADDR_END[15:8] */
	{TSB_8BIT, 0x034B, 0x9F},    /* Y_ADDR_END[7:0] */
...
static struct tsb_reg const t4k35_Full_3280x1852_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{TSB_8BIT, 0x0301, 0x01},    /* -/-/-/-/VT_PIX_CLK_DIV[3:0] */
	{TSB_8BIT, 0x0303, 0x05},    /* -/-/-/-/VT_SYS_CLK_DIV[3:0] */
	{TSB_8BIT, 0x030B, 0x01},    /* -/-/-/-/OP_SYS_CLK_DIV[3:0] */
	...
	{TSB_8BIT, 0x0342, 0x0E},    /* LINE_LENGTH_PCK[15:8] */
	{TSB_8BIT, 0x0343, 0xFA},    /* LINE_LENGTH_PCK[7:0] */
...
static struct tsb_reg const t4k35_Full_3280x1852_15fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	...
	{TSB_8BIT, 0x0821, 0x33},    /* MSB_LBRATE[23:16] */
	{TSB_8BIT, 0x0900, 0x00},    /* -/-/-/-/-/-/H_BIN[1:0] */
	{TSB_8BIT, 0x0901, 0x00},    /* -/-/-/-/-/-/V_BIN_MODE[1:0] */
	{TSB_8BIT, 0x0902, 0x00},    /* -/-/-/-/-/-/BINNING_WEIGHTING[1:0] */
	{TSB_8BIT, 0x32F7, 0x01},    /* -/-/-/-/-/-/-/PP_DCROP_SW */
...
static struct tsb_reg const t4k35_Bin_1632x1228_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{TSB_8BIT, 0x0301, 0x02},    /* -/-/-/-/VT_PIX_CLK_DIV[3:0] */
	...
	{TSB_8BIT, 0x0342, 0x07},    /* LINE_LENGTH_PCK[15:8] */
	{TSB_8BIT, 0x0343, 0xE2},    /* LINE_LENGTH_PCK[7:0] */
	{TSB_8BIT, 0x0346, 0x00},    /* Y_ADDR_START[15:8] */
	{TSB_8BIT, 0x0347, 0x00},    /* Y_ADDR_START[7:0] */
	{TSB_8BIT, 0x034A, 0x09},    /* Y_ADDR_END[15:8] */
	{TSB_8BIT, 0x034B, 0x9F},    /* Y_ADDR_END[7:0] */
...
static struct tsb_reg const t4k35_Bin_1616x916_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{TSB_8BIT, 0x0301, 0x02},    /* -/-/-/-/VT_PIX_CLK_DIV[3:0] */
	{TSB_8BIT, 0x0303, 0x06},    /* -/-/-/-/VT_SYS_CLK_DIV[3:0] */
	{TSB_8BIT, 0x030B, 0x02},    /* -/-/-/-/OP_SYS_CLK_DIV[3:0] */
...
static struct tsb_reg const t4k35_FHD_1936x1096_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{TSB_8BIT, 0x0301, 0x01},    /* -/-/-/-/VT_PIX_CLK_DIV[3:0] */
	{TSB_8BIT, 0x0303, 0x05},    /* -/-/-/-/VT_SYS_CLK_DIV[3:0] */
	{TSB_8BIT, 0x030B, 0x01},    /* -/-/-/-/OP_SYS_CLK_DIV[3:0] */
...
static struct tsb_reg const t4k35_HD_1296x736_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{TSB_8BIT, 0x0301, 0x02},    /* -/-/-/-/VT_PIX_CLK_DIV[3:0] */
	{TSB_8BIT, 0x0303, 0x06},    /* -/-/-/-/VT_SYS_CLK_DIV[3:0] */
	{TSB_8BIT, 0x030B, 0x02},    /* -/-/-/-/OP_SYS_CLK_DIV[3:0] */
...
static struct tsb_reg const t4k35_Bin_736x496_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{TSB_8BIT, 0x0301, 0x02},    /* -/-/-/-/VT_PIX_CLK_DIV[3:0] */
	{TSB_8BIT, 0x0303, 0x06},    /* -/-/-/-/VT_SYS_CLK_DIV[3:0] */
	{TSB_8BIT, 0x030B, 0x02},    /* -/-/-/-/OP_SYS_CLK_DIV[3:0] */
	...
	{TSB_8BIT, 0x0401, 0x02},    /* -/-/-/-/-/-/SCALING_MODE[1:0] */
	{TSB_8BIT, 0x0404, 0x23},    /* SCALE_M[7:0] */
	{TSB_8BIT, 0x0409, 0x0E},    /* DCROP_XOFS[7:0] */
	{TSB_8BIT, 0x040A, 0x00},    /* DCROP_YOFS[15:8] */
	{TSB_8BIT, 0x040B, 0x48},    /* DCROP_YOFS[7:0] */
	{TSB_8BIT, 0x040C, 0x06},    /* DCROP_WIDTH[15:8] */
	{TSB_8BIT, 0x040D, 0x4A},    /* DCROP_WIDTH[7:0] */
	{TSB_8BIT, 0x040E, 0x04},    /* DCROP_HIGT[15:8] */
	{TSB_8BIT, 0x040F, 0x3E},    /* DCROP_HIGT[7:0] */
	{TSB_8BIT, 0x0820, 0x04},    /* MSB_LBRATE[31:24] */
	{TSB_8BIT, 0x0821, 0x33},    /* MSB_LBRATE[23:16] */
	{TSB_8BIT, 0x0900, 0x01},    /* -/-/-/-/-/-/H_BIN[1:0] */
	{TSB_8BIT, 0x0901, 0x01},    /* -/-/-/-/-/-/V_BIN_MODE[1:0] */
...
static struct tsb_reg const t4k35_Bin_656x496_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{TSB_8BIT, 0x0301, 0x02},    /* -/-/-/-/VT_PIX_CLK_DIV[3:0] */
	{TSB_8BIT, 0x0303, 0x06},    /* -/-/-/-/VT_SYS_CLK_DIV[3:0] */
	{TSB_8BIT, 0x030B, 0x02},    /* -/-/-/-/OP_SYS_CLK_DIV[3:0] */
	...
	{TSB_8BIT, 0x040A, 0x00},    /* DCROP_YOFS[15:8] */
	{TSB_8BIT, 0x040B, 0x0A},    /* DCROP_YOFS[7:0] */
	{TSB_8BIT, 0x040C, 0x06},    /* DCROP_WIDTH[15:8] */
	{TSB_8BIT, 0x040D, 0x40},    /* DCROP_WIDTH[7:0] */
	{TSB_8BIT, 0x040E, 0x04},    /* DCROP_HIGT[15:8] */
	{TSB_8BIT, 0x040F, 0xBA},    /* DCROP_HIGT[7:0] */
	{TSB_8BIT, 0x0820, 0x04},    /* MSB_LBRATE[31:24] */
	{TSB_8BIT, 0x0821, 0x33},    /* MSB_LBRATE[23:16] */
	{TSB_8BIT, 0x0900, 0x01},    /* -/-/-/-/-/-/H_BIN[1:0] */
	{TSB_8BIT, 0x0901, 0x01},    /* -/-/-/-/-/-/V_BIN_MODE[1:0] */
...
static struct tsb_reg const t4k35_Bin_368x304_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{TSB_8BIT, 0x0301, 0x02},    /* -/-/-/-/VT_PIX_CLK_DIV[3:0] */
	{TSB_8BIT, 0x0303, 0x06},    /* -/-/-/-/VT_SYS_CLK_DIV[3:0] */
	{TSB_8BIT, 0x030B, 0x02},    /* -/-/-/-/OP_SYS_CLK_DIV[3:0] */
	...
	{TSB_8BIT, 0x0401, 0x02},    /* -/-/-/-/-/-/SCALING_MODE[1:0] */
	{TSB_8BIT, 0x0404, 0x40},    /* SCALE_M[7:0] */
	{TSB_8BIT, 0x0409, 0x54},    /* DCROP_XOFS[7:0] */
	{TSB_8BIT, 0x040A, 0x00},    /* DCROP_YOFS[15:8] */
	{TSB_8BIT, 0x040B, 0x08},    /* DCROP_YOFS[7:0] */
	{TSB_8BIT, 0x040C, 0x05},    /* DCROP_WIDTH[15:8] */
	{TSB_8BIT, 0x040D, 0xC0},    /* DCROP_WIDTH[7:0] */
	{TSB_8BIT, 0x040E, 0x04},    /* DCROP_HIGT[15:8] */
	{TSB_8BIT, 0x040F, 0xC0},    /* DCROP_HIGT[7:0] */
	{TSB_8BIT, 0x0820, 0x04},    /* MSB_LBRATE[31:24] */
	{TSB_8BIT, 0x0821, 0x33},    /* MSB_LBRATE[23:16] */
	{TSB_8BIT, 0x0900, 0x01},    /* -/-/-/-/-/-/H_BIN[1:0] */
	{TSB_8BIT, 0x0901, 0x01},    /* -/-/-/-/-/-/V_BIN_MODE[1:0] */
...
static struct tsb_reg const t4k35_Bin_336x256_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{TSB_8BIT, 0x0301, 0x02},    /* -/-/-/-/VT_PIX_CLK_DIV[3:0] */
	{TSB_8BIT, 0x0303, 0x06},    /* -/-/-/-/VT_SYS_CLK_DIV[3:0] */
	{TSB_8BIT, 0x030B, 0x02},    /* -/-/-/-/OP_SYS_CLK_DIV[3:0] */
	...
	{TSB_8BIT, 0x0401, 0x02},    /* -/-/-/-/-/-/SCALING_MODE[1:0] */
	{TSB_8BIT, 0x0404, 0x4D},    /* SCALE_M[7:0] */
	{TSB_8BIT, 0x0409, 0x0A},    /* DCROP_XOFS[7:0] */
	{TSB_8BIT, 0x040A, 0x00},    /* DCROP_YOFS[15:8] */
	{TSB_8BIT, 0x040B, 0x00},    /* DCROP_YOFS[7:0] */
	{TSB_8BIT, 0x040C, 0x06},    /* DCROP_WIDTH[15:8] */
	{TSB_8BIT, 0x040D, 0x52},    /* DCROP_WIDTH[7:0] */
	{TSB_8BIT, 0x040E, 0x04},    /* DCROP_HIGT[15:8] */
	{TSB_8BIT, 0x040F, 0xD0},    /* DCROP_HIGT[7:0] */
	{TSB_8BIT, 0x0820, 0x04},    /* MSB_LBRATE[31:24] */
	{TSB_8BIT, 0x0821, 0x33},    /* MSB_LBRATE[23:16] */
	{TSB_8BIT, 0x0900, 0x01},    /* -/-/-/-/-/-/H_BIN[1:0] */
	{TSB_8BIT, 0x0901, 0x01},    /* -/-/-/-/-/-/V_BIN_MODE[1:0] */
...
static struct tsb_reg const t4k35_Bin_192x160_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{TSB_8BIT, 0x0301, 0x02},    /* -/-/-/-/VT_PIX_CLK_DIV[3:0] */
	{TSB_8BIT, 0x0303, 0x06},    /* -/-/-/-/VT_SYS_CLK_DIV[3:0] */
	{TSB_8BIT, 0x030B, 0x02},    /* -/-/-/-/OP_SYS_CLK_DIV[3:0] */
	...
	{TSB_8BIT, 0x034F, 0xA0},    /* Y_OUTPUT_SIZE[7:0] */
	{TSB_8BIT, 0x0401, 0x02},    /* -/-/-/-/-/-/SCALING_MODE[1:0] */
	{TSB_8BIT, 0x0404, 0x7B},    /* SCALE_M[7:0] */
...
static struct tsb_reg const t4k35_init_settings[] = {
	...
	{TSB_8BIT, 0x0900, 0x00},    /* -/-/-/-/-/-/H_BIN[1:0] */
	{TSB_8BIT, 0x0901, 0x00},    /* -/-/-/-/-/-/V_BIN_MODE[1:0] */
	{TSB_8BIT, 0x0902, 0x00},    /* -/-/-/-/-/-/BINNING_WEIGHTING[1:0], 0: average bin, 1: sum bin */
	...
	{TSB_8BIT, 0x3427, 0x00},    /* MIPI_CLKVBLK/MIPI_CLK_MODE/-/-/HS_SR_CNT[1:0]/LP_SR_CNT[1:0] */
...
struct tsb_resolution t4k35_res_preview[] = {
	{
		...
		.fps_options = {
			{
				.fps = 30,
				.pixels_per_line = 0x0702,
				.lines_per_frame = 0x05EC,
			},
			{
			}
		},
	...
	},
	{
		...
		.regs = t4k35_Bin_1632x1228_30fps,
		.width = 1632,
		.height = 1228,
		.bin_factor_x = 2,
		.bin_factor_y = 2,
	...
	},
	{
		...
		.regs = t4k35_FHD_1936x1096_30fps,
		.width = 1936,
		.height = 1096,
		.bin_factor_x = 1,
		.bin_factor_y = 1,
	...
	},
	{
		...
		.regs = t4k35_Full_3280x1852_30fps,
		.width = 3280,
		.height = 1852,
		.bin_factor_x = 1,
		.bin_factor_y = 1,
	...
	},
	{
		...
		.regs = t4k35_Full_3280x2464_25fps,
		.width = 3280,
		.height = 2464,
		.bin_factor_x = 1,
		.bin_factor_y = 1,
...
struct tsb_resolution t4k35_res_still[] = {
	...
	},
	{
		...
		.regs = t4k35_Full_3280x1852_15fps,
		.width = 3280,
		.height = 1852,
		.bin_factor_x = 1,
		.bin_factor_y = 1,
	...
	},
	{
		...
		.regs = t4k35_Full_3280x2464_15fps,
		.width = 3280,
		.height = 2464,
		.bin_factor_x = 1,
		.bin_factor_y = 1,
