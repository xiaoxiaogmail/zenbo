 ...
 *
 * Version:1.2
 *      V1.0:2014/05/10 modify by one
 *      1.  Add check BIN/CFG and CFG_Checksum function
 *      2.  Add check RST/INT/I2C function
 *      3.  Add Touch panel enable/disable adb command for digitizer test need disable TP function
 *      4.  Depend on Sensor ID for max/min/cfg/checksum value table
 *      5.  Add one test result
 *      6.  Add printf full node rawdata function depend on .h setting, also show max/min/avg rawdata
 *
 */
...
#define GTP_IC_VERSION "9110" //"915", "968", "927", "928"......
#define GTP_BIN_VERSION 0x1050 //the same with debug board

//Sensor_ID == 0 ~ 5 config, pls also check with gt9xx.h send CFG sensor ID, and double confirm H/W about sensor ID information.
//{CFG_version, CFG_Chksum, max_limit, min_limit, key_val max limit, key_value min limit, screen uniformity in percent}
/* id0 for SR1; id5 for SR2 and later. */
#define GTP_BINCFG_GROUP	{{67, 0x74, 1700, 740, 8000, 100, 60},\
							{72, 0xa6, 3150, 2050, 2800, 1400, 75},\
							{60, 0x01, 8000, 100, 8000, 100, 70},\
							{60, 0x01, 8000, 100, 8000, 100, 70},\
							{60, 0x01, 8000, 100, 8000, 100, 70},\
							{0, 0xA3, 3319, 1474, 8000, 100, 70}}
