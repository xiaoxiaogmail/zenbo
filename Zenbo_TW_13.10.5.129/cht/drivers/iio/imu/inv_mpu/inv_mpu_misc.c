...
#define INV_DO_TEST_DEBUG   0
    ...
    printk("DEF_PACKET_THRESH=%d, packet_size=%d\n", DEF_PACKET_THRESH, packet_size);
    buf_debug = (short *)kmalloc(DEF_PACKET_THRESH * BYTES_PER_SENSOR * 2, GFP_KERNEL);
#endif
